  ...
  return (
    ...
    >
      ...
      <p className="text-sm leading-[150%] text-gray-100 font-light text-center w-[90%]">
        ...
        passion for building dynamic and responsive websites and applications.
        Based in Dilibazar, Kathmandu, I specialize in
        ...
        <span className="text-main-lighter">lead website developement</span> as
        a{" "}
        <Link
